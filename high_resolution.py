...
if __name__=="__main__":
    compute_smoothed_structural_connectivity_over_cifti_from_streamlines(
        _join_path(_main_dir, 'data/100307/tractography/volumetric_probabilistic_tracks_5M.tck'),
        _join_path(_main_dir, 'data/surfaces/100307.L.white.32k_fs_LR.surf.gii'),
        _join_path(_main_dir, 'data/surfaces/100307.R.white.32k_fs_LR.surf.gii'),
        _join_path(_main_dir, 'data/warpfields/100307.MNINonLinear/xfms/standard2acpc_dc.nii.gz'),
        _join_path(_main_dir, 'data/templates/cifti/ones.dscalar.nii'),
        sigma=_fwhm2sigma(2),
        epsilon=0.01
    )